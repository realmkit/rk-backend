...
func Register(router fiber.Router, services Services) {
	...
	group.Put("/owners/:owner_type/:owner_id/metafields/:key", handler.setValue)
	group.Get("/owners/:owner_type/:owner_id/metafields", handler.listValues)
	group.Get("/owners/:owner_type/:owner_id/metafields/:key", handler.getValue)
	group.Delete("/owners/:owner_type/:owner_id/metafields/:key", handler.deleteValue)
